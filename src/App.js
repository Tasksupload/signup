...
//     }
//     console.log(data)
const initialValues={firstname:"",lastname:"",email:"",password:"",confirmPassword:"",Address:""};
...
<div>
    ...
    <input type="radio" value="Other" name="gender" id="others"/> Other
        ...
        <div>
            ...
            <textarea maxLength={50} type="text" name="Address" value={formvalues.Address} placeholder='Please Enter Your Address In 50 Characters Only' onChange={changeHandler} ></textarea>
             </div> 
